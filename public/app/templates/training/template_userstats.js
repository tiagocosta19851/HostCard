...
_.each(evs,function(item3,key3, list ){  
    ...
    <tr> 
       ...
       <td><a class="btn btn-primary btn-see-more-stats-final2" href="/stats/final-quiz/<%-item3.Session%>">See More</a></td>
    </tr> 
...
_.each(evs,function(item1,key1, list ){  
    ...
    <tr> 
       ...
       <td><a class="btn btn-primary btn-see-more-stats-learning2" href="/stats/learning-quiz/<%-item1.Session%>"  data-session="">See More</a></td>
    </tr> 
